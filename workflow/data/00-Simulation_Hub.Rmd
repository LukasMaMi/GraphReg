...
generator <- function (n, p, rho, g, vis, verbose) 
{
    gcinfo(FALSE)
    if (verbose) 
  ...
  g.large = p%%g #Rest Funktion
    ...
    omega = solve(sigma) #Kontrolle, ob Sigma passend zu gewolltem theta erstellt
...
for(rep in 1:num_repetitions) {
  ...
  for(cfg in configs) {
    ...
    hub <- generator(n = n, p = p, rho = rho, g = J, vis = FALSE, verbose = TRUE)
