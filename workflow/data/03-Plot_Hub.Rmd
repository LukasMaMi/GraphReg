...
# Save the plot
ggsave(filename = "F1_Hub_Plot.png", plot = F1_Hub, path = dir_path4, width = 8, height = 6, dpi = 300)
ggsave(filename = "Hamming_Hub_Plot.png", plot = Hamming_Hub, path = dir_path4, width = 8, height = 6, dpi = 300)
