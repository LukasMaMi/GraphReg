...
# Merge sparsity values with F1 and Hamming data frames
merged_f1_df <- merge(mean_f1_df, mean_sparsity_df, by = c("Config", "Method"))
merged_hamming_df <- merge(mean_hamming_df, mean_sparsity_df, by = c("Config", "Method"))
