...
create_lambda_plot <- function(df, title) {
  ggplot(df, aes(x = Config, y = Mean_Lambda, color = Method, group = Method)) +
    Hub_point(position = position_dodge(width = 0.2)) +
    Hub_errorbar(aes(ymin = CI_Lower, ymax = CI_Upper), 
                  width = 0.1, 
...
gap_b_plot <- ggplot(gap_data_all, aes(x = Config, y = Gap_B, color = Graph_Type, group = Graph_Type)) +
  Hub_point() +
  Hub_line(aes(linetype = Graph_Type)) +
  Hub_errorbar(aes(ymin = Gap_B_CI_Lower, ymax = Gap_B_CI_Upper), width = 0.1) +
...
gap_beta_plot <- ggplot(gap_data_all, aes(x = Config, y = Gap_Beta, color = Graph_Type, group = Graph_Type)) +
  Hub_point() +
  Hub_line(aes(linetype = Graph_Type)) +
  Hub_errorbar(aes(ymin = Gap_Beta_CI_Lower, ymax = Gap_Beta_CI_Upper), width = 0.1) +
