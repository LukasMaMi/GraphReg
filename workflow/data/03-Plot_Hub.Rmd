...
F1_Hub_Set_1 <- create_plot(mean_f1_df_set_1, "Hub F1 Scores", "Mean F1 Score")
F1_Hub_Set_2 <- create_plot(mean_f1_df_set_2, "Hub F1 Scores", "Mean F1 Score")
Hamming_Hub_Set_1 <- create_plot(mean_hamming_df_set_1, "Hub Hamming Distances", "Mean Hamming Distance")
Hamming_Hub_Set_2 <- create_plot(mean_hamming_df_set_2, "Hub Hamming Distances", "Mean Hamming Distance")
...
base_dir_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/GCM"
#base_dir_path <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/"
...
# Folders setup
pseudo_folder_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/pseudo"
non_pseudo_folder_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/nonpseudo/"
#pseudo_folder_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/pseudo/"
#non_pseudo_folder_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/nonpseudo/"
...
# Directory paths
dir_path_subsamples_heatmaps_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/subsamples"
#dir_path_subsamples_heatmaps_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/subsamples"
...
# Base paths
dir_path_lam <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Lam_path_plots"
dir_GCM_psd_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/pseudo"
dir_GCM_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/nonpseudo"
dir_Heat_psd_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/pseudo"
dir_Heat_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/nonpseudo"
dir_Heat_Sub_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/subsamples"
dir_GCM_Sub_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/subsamples"

# dir_path_lam <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Lam_path_plots/"
# dir_GCM_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/pseudo/"
# dir_GCM_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/nonpseudo"
# dir_Heat_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/pseudo/"
# dir_Heat_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/nonpseudo/"
# dir_Heat_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/subsamples/"
# dir_GCM_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/GCM/subsamples"
...
# Composite images over image0 at specified positions, adjust Hubetry as needed
...
# dir_path_lam <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Lambda_path_plots/"
# dir_Heat_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/pseudo/"
# dir_Heat_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/nonpseudo/"
# dir_Heat_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Hub/Heatmaps/subsamples/"
...
dir_path_Hubetric <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Performance_Hub"
...
performance_data_Hubetric <- load_performance_data(dir_path_Hubetric)
...
gap_data_Hubetric <- prepare_gap_data(performance_data_Hubetric, "Hubetric")

# Combine the data from different graph types
gap_data_all <- rbind(gap_data_Hub, gap_data_erdos_renyi, gap_data_Hubetric)
...
gap_b_plot <- ggplot(gap_data_all, aes(x = Config, y = Gap_B, color = Graph_Type, group = Graph_Type)) +
  ...
  theme_minimal() +
  scale_color_manual(values = c("Hub" = "blue", "Erdős-Rényi" = "darkgreen", "Hubetric" = "darkred")) +
  scale_linetype_manual(values = c("Hub" = "longdash", "Erdős-Rényi" = "solid", "Hubetric" = "dashed")) +
...
df_rho_3 <- generate_df_for_rho(rho_3, "rho = 0.2, thresh = 0.05, lambda path = 30")
...
library(ggplot2)
ggsave("Hub_graph.pdf", table_plot, width = 10, height = 20, path = "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Hub")
