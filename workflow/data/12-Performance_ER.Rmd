...
save(num_repetitions, configs, dir_path, dir_path2, dir_path3, file="ER_settings.RData")
...
# Function to calculate F1-score and Hamming distance #Frobinius (matrix norm)
...
for(cfg in configs) {
  ...
  for(rep in 1:num_repetitions) {
    sim_filename <- get_filename(cfg, rep, prefix="ER")
