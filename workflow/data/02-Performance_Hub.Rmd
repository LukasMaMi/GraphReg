...
compute_metrics <- function(true_graph, est_graph) {
  ...
  hamming_distance <- sum((est_graph[lower.tri(est_graph)] != true_graph[lower.tri(true_graph)]))
...
for(cfg in configs) {
  ...
  aggregated_metrics <- list(stars = NULL, gstars = NULL, oracle_f1 = NULL, oracle_hamming = NULL)
