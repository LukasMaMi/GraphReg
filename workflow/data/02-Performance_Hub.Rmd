...
for(cfg in configs) {
    ...
    lambda_values_methods <- list(stars = numeric(), gstars = numeric(), pgstars = numeric(), 
                                  oracle_f1 = numeric(), oracle_hamming = numeric())
    sparsity_values_methods <- list(stars = numeric(), gstars = numeric(), pgstars = numeric(), 
                                    oracle_f1 = numeric(), oracle_hamming = numeric())
    gap_values <- list()
    ...
    for(rep in 1:num_repetitions) {
        ...
        pgstars_metrics <- compute_metrics(pgstars_graph, true_graph)
        ...
        additional_metrics <- list(
            ...
            pgstars_lambda = best_lambda_pgstars,
            ...
            pgstars_sparsity = act_sparsity_pgstars,
        ...
        lambda_values_methods$pgstars <- c(lambda_values_methods$pgstars, best_lambda_pgstars)
        ...
        sparsity_values_methods$pgstars <- c(sparsity_values_methods$pgstars, act_sparsity_pgstars)
