...
get_filename <- function(config, rep, prefix = "Hub") {
  ...
  hamming_distance <- function(actual, predicted) {
    sum((predicted[lower.tri(predicted)] != actual[lower.tri(actual)]))
  }
...
save(true_graph, stars_graph, gstars_graph, oracle_graph_f1, oracle_graph_hamming, act_sparsity, act_sparsity_stars, act_sparsity_gstars, act_sparsity_oracle_f1, act_sparsity_oracle_hamming, best_lambda_oracle_f1, best_lambda_oracle_hamming, best_lambda_stars, best_lambda_gstars, stars_index, gstars_index, oracle_index_f1, oracle_index_hamming, stars_lb, stars_ub, out.p, file=paste0(dir_path2, "/", ... = result_filename))
