...
for (cfg_key in names(config_results)) {
  ...
  for (method in names(cfg$Aggregated)) {
    ...
    ci_f1_upper <- ifelse(ci_f1_upper > 1, 1, ci_f1_upper)
    ci_hamming_lower <- aggregated_metrics$Hamming["CI1"]
    ci_hamming_lower <- ifelse(ci_hamming_lower < 0, 0, ci_hamming_lower)
...
method_colors <- c(
  ...
  "gcd_pseudo_spearman" = "coral",
  "gcd_pseudo_kendall" = "magenta",
  "gcd_pseudo_latentcor" = "steelblue",
  "gcd_prior_spearman" = "green",
  "gcd_prior_kendall" = "blue",
  "gcd_prior_latentcor" = "red",
  "gcd_prior_pseudo_spearman" = "coral4",
  "gcd_prior_pseudo_kendall" = "magenta4",
  "gcd_prior_pseudo_latentcor" = "steelblue4"
)
...
# Only GCD
#methods_set_1_f1 <- c("stars", "oracle_f1", "gcd_spearman", "gcd_kendall", "gcd_latentcor", "gcd_prior_spearman", "gcd_prior_kendall", "gcd_prior_latentcor")
...
# GHuST
methods_set_1_f1 <- c("stars", "oracle_f1", "ghust", "ghust_prior", "gcd_spearman", "gcd_prior_spearman")
...
# Hamming GCD
#methods_set_1_hamming <- c("stars", "oracle_hamming", "gcd_spearman", "gcd_kendall", "gcd_latentcor", "null_graph", "gcd_prior_spearman", "gcd_prior_kendall", "gcd_prior_latentcor")
...
# Ghust
methods_set_1_hamming <- c("stars", "oracle_f1", "ghust", "ghust_prior", "gcd_spearman", "gcd_prior_spearman")
...
#methods_set_2_hamming <- c("stars", "oracle_hamming", "gcd_spearman", "gcd_kendall", "gcd_latentcor", "gcd_prior_spearman", "gcd_prior_kendall", "gcd_prior_latentcor", "null_graph")
...
F1_Geom_Set_1 <- create_plot(mean_f1_df_set_1, "Geom F1 Scores", "Mean F1 Score")
F1_Geom_Set_2 <- create_plot(mean_f1_df_set_2, "Geom F1 Scores", "Mean F1 Score")
Hamming_Geom_Set_1 <- create_plot(mean_hamming_df_set_1, "Geom Hamming Distances", "Mean Hamming Distance")
Hamming_Geom_Set_2 <- create_plot(mean_hamming_df_set_2, "Geom Hamming Distances", "Mean Hamming Distance")
...
create_plot <- function(data, gcd_crit, gcd_crit_psd) {
  ...
  p <- p %>%
    add_trace(x = rep(data$lambda_opt_hamming, 2), y = c(0, max_value), 
              ...
              line = list(color = 'rgba(60, 60, 60, 1)', dash = "dot"), showlegend = FALSE)
  ...
  p <- p %>%
    add_trace(x = rep(data$lambda_opt_stars, 2), y = c(0, max_value), 
              type = 'scatter', mode = "lines", 
              line = list(color = 'rgba(173, 216, 230, 1)', dash = "dot"), showlegend = FALSE)
...
#base_dir_path <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/"
        ...
        if (plot_together) {
            ...
            #for (criterion in criteria) {
                for (method in methods) {
                    crit_name <- ifelse(type == "pseudo" && criterion != "oracle_hamming_subsample",
...
#pseudo_folder_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/pseudo/"
#non_pseudo_folder_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/nonpseudo/"
...
#dir_path_subsamples_heatmaps_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/subsamples"
...
# dir_path_lam <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Lam_path_plots/"
# dir_GCM_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/pseudo/"
# dir_GCM_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/nonpseudo"
# dir_Heat_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/pseudo/"
# dir_Heat_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/nonpseudo/"
# dir_Heat_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/subsamples/"
# dir_GCM_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/subsamples"
...
image_lam_path <- image_read(file.path(dir_path_lam, "n_400_p_40_gcd_spearman.pdf"), density = 300)
...
# dir_path_lam <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Lambda_path_plots/"
# dir_Heat_psd_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/pseudo/"
# dir_Heat_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/nonpseudo/"
# dir_Heat_Sub_base <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/subsamples/"
...
## Convert PDFs to images
image_lam_path <- image_read(file.path(dir_path_lam, "n_400_p_40_ghust.pdf"), density = 300)
...
generate_df_for_rho <- function(data_list, rho_descriptor) {
  ...
  configs <- c("n_400_p_40", "n_400_p_100", "n_400_p_200", "n_400_p_400")
...
df_rho_3 <- generate_df_for_rho(rho_3, "rho = 0.245, thresh = 0.05, lambda path = 30")
...
library(ggplot2)
ggsave("Geom_graph.pdf", table_plot, width = 10, height = 20, path = "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom")
