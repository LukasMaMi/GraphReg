...
```{r}
## Rho 0.245
rho_0_245_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/"

rho_0_245_performance_filename <- file.path(rho_0_245_path, "all_performance_results_geom.RData")
load(rho_0_245_performance_filename)

#
rho_0_245 <- config_results
rm(config_results)



## Rho 0.17
rho_min1_min0_03_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/"

rho_min1_min0_03_performance_filename <- file.path(rho_min1_min0_03_path, "all_performance_results_ER.RData")
load(rho_min1_min0_03_performance_filename)

#
rho_min1_min0_03 <- config_results
rm(config_results)
...
# Generate data frames for each rho value
df_rho_0_245 <- generate_df_for_rho(rho_0_245, "Geom rho = 0.245")
df_rho_min1_min0_03 <- generate_df_for_rho(rho_min1_min0_03, "ER rho = [-1, -0.1], [0.1, 1]")

# Combine the data frames
combined_df <- rbind(df_rho_0_245, df_rho_min1_min0_03)
...
library(ggplot2)
ggsave("graph_rho.pdf", table_plot, width = 10, height = 20, path = "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/")
