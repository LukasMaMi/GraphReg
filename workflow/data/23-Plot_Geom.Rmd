...
base_dir_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/GCM"
            ...
            for (criterion in criteria) {
                for (method in methods) {
                    ...
                    if (!is.null(gcm_list[[config_key]][[crit_name]])) {
                        corrplot(gcm_list[[config_key]][[crit_name]], method = "circle", addgrid.col = NA, tl.pos = "lt", cl.pos = "n")
...
# Folders setup
pseudo_folder_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/pseudo"
non_pseudo_folder_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/nonpseudo/"
...
# Directory paths
dir_path_subsamples_heatmaps_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/subsamples"
...
## Gather Hamming Distance and GCD
```{r}
...
create_and_save_plots <- function(config_results, configs, dir_path) {
  ...
  for (config in configs) {
    ...
    gcd_criteria <- grep("^gcd_[^p]", criteria, value = TRUE)  # gcd_ but not starting with pseudo
    gcd_prior_criteria <- grep("^gcd_prior_[^p]", criteria, value = TRUE)  # gcd_prior_ but not starting with pseudo
...
# Base paths
dir_path_lam <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Lam_path_plots"
dir_GCM_psd_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/pseudo"
dir_GCM_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/nonpseudo"
dir_Heat_psd_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/pseudo"
dir_Heat_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/nonpseudo"
dir_Heat_Sub_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/Heatmaps/subsamples"
dir_GCM_Sub_base <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_Geom/GCM/subsamples"
...
composite_image <- image_composite(image_lam_path, GCM_gcd_resized, offset = "+100+130")   # Adjust "+50+50" as needed
composite_image <- image_composite(composite_image, GCM_gcd_prior_resized, offset = "+800+130") # Adjust for positioning
composite_image <- image_composite(composite_image, GCM_oracle_resized, offset = "+1500+130") # Adjust for positioning

# Adding Heatmap
composite_image <- image_composite(composite_image, Heat_gcd_resized, offset = "+350+130")
composite_image <- image_composite(composite_image, Heat_gcd_prior_resized, offset = "+1050+130")
composite_image <- image_composite(composite_image, Heat_oracle_resized, offset = "+1750+130")

# Adding GCM subsamples
composite_image <- image_composite(composite_image, GCM_Sub1_resized, offset = "+100+1100")
composite_image <- image_composite(composite_image, GCM_Sub2_resized, offset = "+800+1100")
composite_image <- image_composite(composite_image, GCM_Sub3_resized, offset = "+1500+1100")

# Adding heatmap subsamples
composite_image <- image_composite(composite_image, Heat_Sub1_resized, offset = "+350+1300")
composite_image <- image_composite(composite_image, Heat_Sub2_resized, offset = "+1050+1300")
composite_image <- image_composite(composite_image, Heat_Sub3_resized, offset = "+1750+1300")

# Adding true graph
composite_image <- image_composite(composite_image, Heat_True_resized, offset = "+50+700")
composite_image <- image_composite(composite_image, GCM_True_resized, offset = "+50+950")
...
GCD_text1 <- sprintf("%s: %.3f", meth, GCD_value1)
GCD_text2 <- sprintf("%s: %.3f", meth, GCD_value2)
GCD_text3 <- sprintf("%s: %.3f", meth, GCD_value3)

# Converting the GCD value to a string with formatting
GCD_text4 <- sprintf("%s: %.3f", meth, GCD_value4)
GCD_text5 <- sprintf("%s: %.3f", meth, GCD_value5)
GCD_text6 <- sprintf("%s: %.3f", meth, GCD_value6)


# Extracting the Ham_Dist value for the specific method
Ham_Dist_value1 <- Ham_Dist[[config_key]][["gcd_spearman"]]
Ham_Dist_value2 <- Ham_Dist[[config_key]][["gcd_prior_spearman"]]
Ham_Dist_value3 <- Ham_Dist[[config_key]][["oracle_hamming_spearman"]]

Ham_Dist_value4 <- Ham_Dist[[config_key]][["Sub1"]]
Ham_Dist_value5 <- Ham_Dist[[config_key]][["Sub2"]]
Ham_Dist_value6 <- Ham_Dist[[config_key]][["Sub3"]]

# Converting the Ham_Dist value to a string with formatting
Ham_Dist_text1 <- sprintf("%s: %.3f", meth, Ham_Dist_value1)
Ham_Dist_text2 <- sprintf("%s: %.3f", meth, Ham_Dist_value2)
Ham_Dist_text3 <- sprintf("%s: %.3f", meth, Ham_Dist_value3)

# Converting the Ham_Dist value to a string with formatting
Ham_Dist_text4 <- sprintf("%s: %.3f", meth, Ham_Dist_value4)
Ham_Dist_text5 <- sprintf("%s: %.3f", meth, Ham_Dist_value5)
Ham_Dist_text6 <- sprintf("%s: %.3f", meth, Ham_Dist_value6)

# Choose where you want to place the annotation on your image
# Adjust the "+x+y" values to place the text where you prefer
location_offset <- "+100+400" # Example position, adjust as needed

# # Annotate the composite image with the method name and GCD value
