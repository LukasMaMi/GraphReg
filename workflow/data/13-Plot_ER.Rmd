...
## Rho -1, -0.1
rho_min1_min0_1_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/3p_min1_min01_cn100"

rho_min1_min0_1_settings_file <- file.path(rho_min1_min0_1_path, "ER_settings.RData")
load(rho_min1_min0_1_settings_file)

rho_min1_min0_1_performance_filename <- file.path(rho_min1_min0_1_path, "all_performance_results.RData")
load(rho_min1_min0_1_performance_filename)

#
rho_min1_min0_1 <- config_results
rm(config_results)
#


## Rho 0.1, 1
rho_01_1_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/3p_01_1_cn100"

rho_01_1_ER_settings_file <- file.path(rho_01_1_path, "ER_settings.RData")
load(rho_01_1_ER_settings_file)

rho_01_1_performance_filename <- file.path(rho_01_1_path, "all_performance_results.RData")
load(rho_01_1_performance_filename)

#
rho_01_1 <- config_results
rm(config_results)
#


## Rho -1, 1
rho_min1_1_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/3p_min1_1_cn100"

rho_min1_1_ER_settings_file <- file.path(rho_min1_1_path, "ER_settings.RData")
load(rho_min1_1_ER_settings_file)

rho_min1_1_performance_filename <- file.path(rho_min1_1_path, "all_performance_results.RData")
load(rho_min1_1_performance_filename)

#
rho_min1_1<- config_results
rm(config_results)
#
...
df_rho_0_1 <- generate_df_for_rho(rho_min1_min0_1, "rho = [-1, 0.1]")
df_rho_0_15 <- generate_df_for_rho(rho_01_1, "rho = [0.1, 1]")
df_rho_0_2 <- generate_df_for_rho(rho_min1_1, "rho = [-1, 1]")
