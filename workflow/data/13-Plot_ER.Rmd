...
# Filter Data Frames
mean_f1_df_filtered <- mean_f1_df %>% filter(Method != "Oracle_hamming")
...
Hamming_ER <- ggplot(mean_hamming_df_filtered, aes(x = Config, y = Mean_Hamming, color = Method)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
        ...
        legend.title = element_blank(),
        axis.text.x = element_text(angle = 30, hjust = 1)) +
  scale_color_manual(values = c("Stars" = "lightblue", "GStars" = "darkorange", "Oracle_hamming" = "black")) +
  theme(axis.text.x = ggtext::element_markdown(angle = 30, hjust = 1))
...
## Rho 0.1
rho_0_1_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/rho_0_1"

rho_0_1_ER_settings_file <- file.path(rho_0_1_path, "rho_0_1_ER_settings.RData")
load(rho_0_1_ER_settings_file)
...
## Rho 0.15
rho_0_15_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/rho_0_15"

rho_0_15_ER_settings_file <- file.path(rho_0_15_path, "rho_0_15_ER_settings.RData")
load(rho_0_15_ER_settings_file)
...
## Rho 0.2
rho_0_2_path <- "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/rho_0_2"

rho_0_2_ER_settings_file <- file.path(rho_0_2_path, "rho_0_2_ER_settings.RData")
load(rho_0_2_ER_settings_file)
...
generate_df_for_rho <- function(data_list, rho_descriptor) {
  ...
  methods <- c("Oracle_f1", "Oracle_hamming", "Stars", "GStars")  # Updated methods
...
library(ggplot2)
ggsave("ER_graph_rho.pdf", table_plot, width = 20, height = 15, path = "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Schrott/ER/")
