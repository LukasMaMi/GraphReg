...
df_rho_3 <- generate_df_for_rho(rho_3, "rho = [-1, -0.8], [0.8, 1], thresh = 0.05, lambda path = 30")
...
library(ggplot2)
ggsave("ER_graph.pdf", table_plot, width = 10, height = 20, path = "/Users/bropc/Documents/LMU/Master Statistics and Data Science/Masterarbeit/R Master/StARS_Simulations/workflow/Storage_Plot_ER")
