...
aggfun <- function(job, res) lapply(res, my.gcvec) 
...
for (i in 1:length(criterion)) {
    ...
    est$gcd_prior <- gcd.stability_extended(NULL, thresh, rep.num, p, nlams, gcdmerge, 
...
gcd.stability_extended <- function(premerge, thresh, rep.num, p, nlams, merge=NULL, prior_graph) {
