...
#devtools::install_gitER("zdk123/pulsar")
...
#dir_path <- "C:/R Projekte/StARS_Simulations/workflow/Storage_Simulation_ER"
...
for (rep in 1:num_repetitions) {
  for (i in seq_along(configs)) {
    ...
    save(num_repetitions, configs, dir_path, dir_path2, dir_path_results, file = ER_settings_file)
